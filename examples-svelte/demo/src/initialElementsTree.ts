...
const circleStyle = `width: ${CIRCLE}px; height: ${CIRCLE}px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 600; padding: 0; text-align: center;`;
...
const engNodes: Node[] = [
  {
    ...
    position: { x: 0, y: 80 },
    style: "width: 10px; height: 10px; background-color: rgba(59, 130, 246, 0.06); border: 1px dashed #3b82f6; border-radius: 12px;",
    type: "group",
  },
  {
    id: "vp-eng",
  ...
  // Frontend subtree
  {
    ...
    parentId: "eng-group",
    expandParent: true,
    style: "width: 10px; height: 10px; background-color: rgba(168, 85, 247, 0.06); border: 1px dashed #a855f7; border-radius: 8px;",
    type: "group",
  },
  {
    id: "fe-lead",
  ...
  // Backend subtree
  {
    ...
    parentId: "eng-group",
    expandParent: true,
    style: "width: 10px; height: 10px; background-color: rgba(20, 184, 166, 0.06); border: 1px dashed #14b8a6; border-radius: 8px;",
    type: "group",
  },
  {
    id: "be-lead",
...
const productNodes: Node[] = [
  {
    ...
    data: { label: "Product" },
    position: { x: 300, y: 80 },
    style: "width: 10px; height: 10px; background-color: rgba(245, 158, 11, 0.06); border: 1px dashed #f59e0b; border-radius: 12px;",
    type: "group",
  },
  {
    id: "vp-product",
...
const opsNodes: Node[] = [
  {
    ...
    position: { x: 500, y: 80 },
    style: "width: 10px; height: 10px; background-color: rgba(236, 72, 153, 0.06); border: 1px dashed #ec4899; border-radius: 12px;",
    type: "group",
  },
  {
    id: "vp-ops",
