...
export const nodes: Node[] = [
  ...
  // ── Group A: Processing ──
  {
    ...
    type: "group",
    position: { x: 250, y: 0 },
    style: "width: 380px; height: 420px; background-color: rgba(59, 130, 246, 0.05); border: 1px dashed #3b82f6; border-radius: 8px;",
  },
  {
    id: "validate",
    data: { label: "Validate" },
  ...
  // ── Group B: Output ──
  {
    ...
    type: "group",
    position: { x: 940, y: 20 },
    style: "width: 340px; height: 460px; background-color: rgba(34, 197, 94, 0.05); border: 1px dashed #22c55e; border-radius: 8px;",
  },
  {
    id: "success",
    data: { label: "Success" },
