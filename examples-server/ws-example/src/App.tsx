...
import { useServerRouter } from "./useServerRouter";
...
export default function App() {
  ...
  const { routes, updateRoutingOnNodesChange, resetRouting } = useServerRouter(
    nodes,
    edges,
    {
  ...
  return (
    <div style={{ width: "100vw", height: "100vh" }}>
      ...
      >
        WebSocket Example — edges routed on server
      </div>
