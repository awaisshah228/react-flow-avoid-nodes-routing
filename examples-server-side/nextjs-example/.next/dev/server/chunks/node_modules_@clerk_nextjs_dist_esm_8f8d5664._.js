...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-NZDU2SC3.mjs [middleware] (ecmascript) <locals>");
...
const serverRedirectWithAuth = (clerkRequest, res, opts)=>{
    ...
    const shouldAppendDevBrowser = res.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ClerkRedirectTo) === "true";
    if (shouldAppendDevBrowser && !!location && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$DuxzP8MU$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__o__as__isDevelopmentFromSecretKey$3e$__["isDevelopmentFromSecretKey"])(opts.secretKey) && clerkRequest.clerkUrl.isCrossOrigin(location)) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(urlWithDevBrowser.href, res);
    }
    return res;
};
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$package$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/avoid-nodes-pro-example/examples-server-side/nextjs-example/node_modules/next/package.json (json)");
...
function debugLogFooter(name) {
    return `[clerk debug end: ${name}] (@clerk/nextjs=${"7.0.2"},next=${__TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$package$2e$json__$28$json$29$__["default"].version},timestamp=${Math.round(/* @__PURE__ */ new Date().getTime() / 1e3)})`;
}
...
async function buildRequestLike() {
    try {
        const { headers } = await __turbopack_context__.A("[project]/avoid-nodes-pro-example/examples-server-side/nextjs-example/node_modules/next/headers.js [middleware] (ecmascript, async loader)");
        const resolvedHeaders = await headers();
        return new __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextRequest"]("https://placeholder.com", {
...
function getAuthKeyFromRequest(req, key) {
    return getCustomAttributeFromRequest(req, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Attributes[key]) || getHeader(req, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers[key]);
}
...
function meetsNextMinimumVersion(minimumMajorVersion) {
    var _a;
    if (!((_a = __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$package$2e$json__$28$json$29$__["default"]) == null ? void 0 : _a.version)) {
        return false;
    }
    const majorVersion = parseInt(__TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$package$2e$json__$28$json$29$__["default"].version.split(".")[0], 10);
...
function decorateRequest(req, res, requestState, requestData, keylessMode, machineAuthObject) {
    ...
    if (!res) {
        res = __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next();
    }
    ...
    if (rewriteURL) {
        ...
        setRequestHeadersOnNextResponse(res, req, {
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.AuthStatus]: status,
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.AuthToken]: token || "",
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.AuthSignature]: token ? createTokenSignature(token, (requestData == null ? void 0 : requestData.secretKey) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$constants$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["SECRET_KEY"] || keylessMode.secretKey || "") : "",
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.AuthMessage]: message || "",
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.AuthReason]: reason || "",
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ClerkUrl]: req.clerkUrl.toString(),
            ...clerkRequestData ? {
                [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ClerkRequestData]: clerkRequestData
            } : {}
        });
...
const redirectAdapter = (url)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(url, {
        headers: {
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ClerkRedirectTo]: "true"
        }
    });
};
...
function createContentSecurityPolicyHeaders(host, options) {
    ...
    if (options.reportTo) {
        ...
        headers.push([
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ReportingEndpoints,
            `csp-endpoint="${options.reportTo}"`
        ]);
    }
    if (options.reportOnly) {
        headers.push([
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ContentSecurityPolicyReportOnly,
            cspHeader
        ]);
    } else {
        headers.push([
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ContentSecurityPolicy,
            cspHeader
        ]);
    }
    if (nonce) {
        headers.push([
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Nonce,
            nonce
        ]);
    }
    return {
...
function createProtect(opts) {
    ...
    return async (...args)=>{
        ...
        const requestedToken = ((_e = args[0]) == null ? void 0 : _e.token) || ((_f = args[1]) == null ? void 0 : _f.token) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken;
        ...
        const handleUnauthorized = ()=>{
            if (authObject.tokenType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isTokenTypeAccepted"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken, requestedToken)) {
                return unauthorized();
            }
            if (unauthorizedUrl) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isTokenTypeAccepted"])(authObject.tokenType, requestedToken)) {
            return handleUnauthorized();
        }
        if (authObject.tokenType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken) {
...
const isServerActionRequest = (req)=>{
    var _a, _b;
    return !!req.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$constants$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["constants"].Headers.NextUrl) && (((_a = req.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Accept)) == null ? void 0 : _a.includes("text/x-component")) || ((_b = req.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ContentType)) == null ? void 0 : _b.includes("multipart/form-data")) || !!req.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$constants$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["constants"].Headers.NextAction));
};
const isPageRequest = (req)=>{
    var _a;
    return req.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.SecFetchDest) === "document" || req.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.SecFetchDest) === "iframe" || ((_a = req.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Accept)) == null ? void 0 : _a.includes("text/html")) || isAppRouterInternalNavigation(req) || isPagesRouterInternalNavigation(req);
};
...
const clerkMiddleware = (...args)=>{
    ...
    const middleware = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$middleware$2d$storage$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["clerkMiddlewareRequestDataStorage"].run(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$middleware$2d$storage$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["clerkMiddlewareRequestDataStore"], ()=>{
        const baseNextMiddleware = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$utils$2f$debugLogger$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["withLogger"])("clerkMiddleware", (logger)=>async (request2, event2)=>{
                ...
                const clerkRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClerkRequest"])(request2);
                logger.debug("options", options);
                logger.debug("url", ()=>clerkRequest.toJSON());
                const authHeader = request2.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Authorization);
                if (authHeader && authHeader.startsWith("Basic ")) {
                    logger.debug("Basic Auth detected");
                }
                const cspHeader = request2.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ContentSecurityPolicy);
                if (cspHeader) {
                ...
                const locationHeader = requestState.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Location);
                if (locationHeader) {
                    ...
                    const res = __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(requestState.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Location) || locationHeader);
                    requestState.headers.forEach((value, key)=>{
                        if (key === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Location) {
                            return;
                        }
                        res.headers.append(key, value);
                    });
                    return res;
                } else if (requestState.status === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AuthStatus"].Handshake) {
                ...
                let handlerResult = __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next();
                try {
                ...
                if (requestState.headers) {
                    requestState.headers.forEach((value, key)=>{
                        if (key === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.ContentSecurityPolicy) {
                            logger.debug("Content-Security-Policy detected", ()=>({
                                    value
                                }));
                        }
                ...
                if (options.debug) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$utils$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["setRequestHeadersOnNextResponse"])(handlerResult, clerkRequest, {
                        [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.EnableDebug]: "true"
                    });
                }
        ...
        const keylessMiddleware = async (request2, event2)=>{
            ...
            const authHeader = (_b = (_a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$headers$2d$utils$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["getHeader"])(request2, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.Authorization)) == null ? void 0 : _a.replace("Bearer ", "")) != null ? _b : "";
            if (isMissingPublishableKey && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isMachineTokenByPrefix"])(authHeader)) {
                const res = __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next();
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$utils$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["setRequestHeadersOnNextResponse"])(res, request2, {
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.AuthStatus]: "signed-out"
                });
                return res;
            }
...
const returnBackFromKeylessSync = (request)=>{
    ...
    url.pathname = "";
    return __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(returnUrl || url.toString());
};
...
const createMiddlewareProtect = (clerkRequest, rawAuthObject, redirectToSignIn)=>{
    return async (params, options)=>{
        const notFound = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["notFound"])();
        ...
        const requestedToken = (params == null ? void 0 : params.token) || (options == null ? void 0 : options.token) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken;
        const authObject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAuthObjectForAcceptedToken"])({
...
const createMiddlewareAuthHandler = (requestState, redirectToSignIn, redirectToSignUp)=>{
    const authHandler = async (options)=>{
        ...
        const acceptsToken = (_a = options == null ? void 0 : options.acceptsToken) != null ? _a : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken;
        const authObject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAuthObjectForAcceptedToken"])({
            authObject: rawAuthObject,
            acceptsToken
        });
        if (authObject.tokenType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isTokenTypeAccepted"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].SessionToken, acceptsToken)) {
...
const handleControlFlowErrors = (e, clerkRequest, nextRequest, requestState)=>{
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$nextErrors$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["isNextjsUnauthorizedError"])(e)) {
        const response = new __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"](null, {
            status: 401
        });
        const authObject = requestState.toAuth();
        if (authObject && authObject.tokenType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenType"].OAuthToken) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$nextErrors$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["isNextjsNotFoundError"])(e)) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$avoid$2d$nodes$2d$pro$2d$example$2f$examples$2d$server$2d$side$2f$nextjs$2d$example$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL(`/clerk_${Date.now()}`, nextRequest.url)), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["constants"].Headers.AuthReason, "protect-rewrite");
    }
    ...
    if (isRedirectToSignIn || isRedirectToSignUp) {
        const redirect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$NZDU2SC3$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createRedirect"])({
...
//# sourceMappingURL=node_modules_%40clerk_nextjs_dist_esm_8f8d5664._.js.map