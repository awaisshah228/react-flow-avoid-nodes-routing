module.exports = [
"[project]/avoid-nodes-pro-example/node_modules/elkjs/lib/elk-api.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/avoid-nodes-pro-example/node_modules/elkjs/lib/main.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * 
 * SPDX-License-Identifier: EPL-2.0
 *******************************************************************************/ var ELK = __turbopack_context__.r("[project]/avoid-nodes-pro-example/node_modules/elkjs/lib/elk-api.js [app-route] (ecmascript)").default;
var ELKNode = function(_ELK) {
    ...
    function ELKNode() {
        ...
        try {
            "[project]/node_modules/web-worker/src/node/index.js [app-route] (ecmascript)";
            workerThreadsExist = true;
        } catch (e) {}
        // user requested a worker
        if (options.workerUrl) {
            if (workerThreadsExist) {
                var Worker = __turbopack_context__.r("[project]/node_modules/web-worker/src/node/index.js [app-route] (ecmascript)");
        ...
        if (!optionsClone.workerFactory) {
            var _require = __turbopack_context__.r("[project]/avoid-nodes-pro-example/node_modules/elkjs/lib/elk-worker.min.js [app-route] (ecmascript)"), _Worker = _require.Worker;
            optionsClone.workerFactory = function(url) {
...
//# sourceMappingURL=dae4a_elkjs_lib_1754b41a._.js.map